...
public:
    ...
    void setupUi(QMainWindow *editwindow)
    {
        ...
        fileopen->setIcon(icon);
        filesaveother = new QAction(editwindow);
        filesaveother->setObjectName(QString::fromUtf8("filesaveother"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/saveother.png"), QSize(), QIcon::Normal, QIcon::Off);
        filesaveother->setIcon(icon1);
        enlarge = new QAction(editwindow);
        enlarge->setObjectName(QString::fromUtf8("enlarge"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/enlarge.png"), QSize(), QIcon::Normal, QIcon::Off);
        enlarge->setIcon(icon2);
        narrow = new QAction(editwindow);
        narrow->setObjectName(QString::fromUtf8("narrow"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/narrow.png"), QSize(), QIcon::Normal, QIcon::Off);
        narrow->setIcon(icon3);
        paintrec = new QAction(editwindow);
        paintrec->setObjectName(QString::fromUtf8("paintrec"));
        paintrec->setCheckable(true);
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/paintrectangle.png"), QSize(), QIcon::Normal, QIcon::Off);
        paintrec->setIcon(icon4);
        paintarrow = new QAction(editwindow);
        paintarrow->setObjectName(QString::fromUtf8("paintarrow"));
        paintarrow->setCheckable(true);
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/paintarrow.png"), QSize(), QIcon::Normal, QIcon::Off);
        paintarrow->setIcon(icon5);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/drawfreedom.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionpaintfreedom->setIcon(icon6);
        actionupload = new QAction(editwindow);
        actionupload->setObjectName(QString::fromUtf8("actionupload"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/upload.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionupload->setIcon(icon7);
        setting = new QAction(editwindow);
        setting->setObjectName(QString::fromUtf8("setting"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/set.png"), QSize(), QIcon::Normal, QIcon::Off);
        setting->setIcon(icon8);
