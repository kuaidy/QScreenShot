...
public:
    ...
    void setupUi(QMainWindow *editwindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/new/prefix1/image/new.png"), QSize(), QIcon::Normal, QIcon::Off);
        filenew->setIcon(icon);
        fileopen = new QAction(editwindow);
        fileopen->setObjectName(QString::fromUtf8("fileopen"));
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/new/prefix1/image/open.png"), QSize(), QIcon::Normal, QIcon::Off);
        fileopen->setIcon(icon1);
        filesaveother = new QAction(editwindow);
        filesaveother->setObjectName(QString::fromUtf8("filesaveother"));
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/new/prefix1/image/saveother.png"), QSize(), QIcon::Normal, QIcon::Off);
        filesaveother->setIcon(icon2);
        enlarge = new QAction(editwindow);
        enlarge->setObjectName(QString::fromUtf8("enlarge"));
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/new/prefix1/image/enlarge.png"), QSize(), QIcon::Normal, QIcon::Off);
        enlarge->setIcon(icon3);
        narrow = new QAction(editwindow);
        narrow->setObjectName(QString::fromUtf8("narrow"));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/new/prefix1/image/narrow.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/new/prefix1/image/paintrectangle.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/new/prefix1/image/paintarrow.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/new/prefix1/image/drawfreedom.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/new/prefix1/image/upload.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionupload->setIcon(icon8);
        setting = new QAction(editwindow);
        setting->setObjectName(QString::fromUtf8("setting"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/new/prefix1/image/set.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/new/prefix1/image/tailoring.png"), QSize(), QIcon::Normal, QIcon::Off);
